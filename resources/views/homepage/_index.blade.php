<x-guest-layout>
    ...
    <div class="" x-data="{announcement: true}" x-cloak>
        <button class="fixed bottom-4 left-4 bg-rose-200 p-4 rounded-full z-50 shadow-xl" @click="announcement = !announcement">
        ...
        <div class="fixed bottom-24 z-50 mx-4 inset-x-0 md:inset-x-auto md:max-w-xl " x-transition x-show="announcement">
