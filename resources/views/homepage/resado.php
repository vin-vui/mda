<section id="resado" class='relative overflow-hidden bg-purple-50'>
    ...
    <img src='images/dots-chaos.svg' class='absolute bottom-0 right-0 z-10 hidden h-auto transform 2xl:block w-80'
        alt=''>
    <img src='images/dots-strip.svg' class='absolute z-10 hidden h-auto transform 2xl:block top-1 right-20 w-36' alt=''>

    <!-- Main Section-->
    <div
        class='relative w-full px-4 py-16 bg-purple-600 2xl:max-w-screen-xl 2xl:mx-auto 2xl:rounded-l-5xl sm:px-6 lg:pr-0 sm:py-24 lg:py-0'>
        <div class='relative grid gap-12 lg:grid-cols-2 2xl:gap-4 lg:pr-10 2xl:pr-0'>
            <div
                class='relative grid order-2 w-full max-w-2xl grid-cols-2 gap-3 mx-auto lg:order-1 sm:gap-6 lg:py-32 lg:max-w-none'>

                <img src='images/dots-purple-mess.svg'
                    class='absolute hidden transform lg:block top-12 -right-16 2xl:right-0 ' alt=''>
                <img src='images/dots-grid.svg'
