        ...
        <div class="flex flex-col sm:flex-row gap-4 items-start px-6 mt-4">
            ...
            <div class="basis-1/2 w-full">
                ...
                <div x-data="{photoName: null, photoPreview: null, sending: false}">
                    <input id="{{ $this->target[1] }}" type="file" class="hidden" wire:model="{{ $target[2] }}" x-ref="photo" accept="image/png, image/jpeg" />
    ...
    <div class="bg-white overflow-hidden shadow-md sm:rounded-3xl sm:my-12 my-6 pb-8">
        ...
        <div class="flex px-6 mt-4 gap-4">
            <div class="basis-1/2">
                ...
                <div x-data="{photoName: null, photoPreview: null, sending: false}">
                    <input id="input_1" type="file" class="hidden" wire:model="photo_1" x-ref="photo" accept="image/png, image/jpeg" />
                    <div class="flex items-center justify-between mt-2">
                        <div class="">
            ...
            <div class="basis-1/2">
                ...
                <div x-data="{photoName: null, photoPreview: null, sending: false}">
                    <input id="input_2" type="file" class="hidden" wire:model="photo_2" x-ref="photo" accept="image/png, image/jpeg" />
                    <div class="flex items-center justify-between mt-2">
                        <div class="">
                            <x-jet-secondary-button class="2" type="button" x-on:click.prevent="$refs.photo.click()">
                                <span class="py-1">sélectionner une nouvelle image</span>
        ...
        <div class="flex px-6 mt-4 gap-4">
            <div class="basis-1/2">
                ...
                <div x-data="{photoName: null, photoPreview: null, sending: false}">
                    <input id="input_3" type="file" class="hidden" wire:model="photo_3" x-ref="photo" accept="image/png, image/jpeg" />
                    <div class="flex items-center justify-between mt-2">
                        <div class="">
                            <x-jet-secondary-button class="2" type="button" x-on:click.prevent="$refs.photo.click()">
                                <span class="py-1">sélectionner une nouvelle image</span>
            ...
            <div class="basis-1/2">
                ...
                <div x-data="{photoName: null, photoPreview: null, sending: false}">
                    <input id="input_4" type="file" class="hidden" wire:model="photo_4" x-ref="photo" accept="image/png, image/jpeg" />
                    <div class="flex items-center justify-between mt-2">
                        <div class="">
                            <x-jet-secondary-button class="2" type="button" x-on:click.prevent="$refs.photo.click()">
                                <span class="py-1">sélectionner une nouvelle image</span>
