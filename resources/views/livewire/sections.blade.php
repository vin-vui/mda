            ...
            <div class="flex px-6 mt-4 gap-4">
                ...
                <div class="basis-1/3">
                    <div class="">
                        ...
                        <img src="{{ $this->image_5->temporaryUrl() }}" alt="" class="mt-2 h-64 object-cover w-full  rounded-2xl border-2 border-purple-50">
                        @else
                        <img src="{{ Storage::disk('uploads')->url($this->image_5) }}" alt="" class="mt-2 h-64 object-cover w-full  rounded-2xl border-2 border-purple-50">
                        @endif
                    </div>
                    <div x-data="{photoName: null, photoPreview: null}">
                        <input type="file" class="hidden" wire:model="image_5" x-ref="photo" />
                        <x-jet-secondary-button class="mt-2 mr-2" type="button" x-on:click.prevent="$refs.photo.click()">
                            <span class="py-1">sélectionner une nouvelle image</span>
                            <div wire:loading wire:target="image_5" wire:key="image_5">
                                <svg class="ml-3 text-green-600 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2">
                                        <path stroke-dasharray="2 4" stroke-dashoffset="6" d="M12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3">
                                            <animate attributeName="stroke-dashoffset" dur="0.6s" repeatCount="indefinite" values="6;0" />
